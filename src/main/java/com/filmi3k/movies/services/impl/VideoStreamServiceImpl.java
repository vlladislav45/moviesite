...
import com.filmi3k.movies.services.base.VideoStreamService;
...
public class VideoStreamServiceImpl implements VideoStreamService {
    ...
    public ResponseEntity<byte[]> prepareContent(String fileName, String fileType, String range) {
        ...
        byte[] data;
        Long fileSize;
        String fullFileName = fileName + "." + fileType; // File name with the type
        try {
            fileSize = getFileSize(fullFileName); // Size of the file
            if (range == null) {
